...
class TestResultLogger:
    ...
    def log_test_result(self, ssd_sn: str, test_item: str, temperature: float, content: str, test_time: Optional[str] = None):
        if test_time is None:
            test_time = self._get_test_time()
        
        test_path = self._create_test_log_path(ssd_sn, test_time)
        filename = self._generate_filename(test_time, ssd_sn, test_item, temperature)
